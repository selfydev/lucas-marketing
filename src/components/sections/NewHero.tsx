	...
	return (
		...
		>
          ...
          `,
			...
			<div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
				...
				<a
					...
					style={{
						...
						boxShadow:
							"0 4px 14px rgba(52, 199, 89, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.15)",
					}}
					tabIndex={0}
				>
					Message Lucas
			...
			{/* Cloud Left */}
			<div
				className="pointer-events-none absolute -bottom-[80px] sm:-bottom-[60px] md:-bottom-[80px] -left-[40px] sm:left-0 md:left-0 z-30 w-[280px] sm:w-[350px] md:w-[400px] lg:w-[509px]"
				aria-hidden="true"
			>
				<img
			...
			{/* Cloud Right */}
			<div
				className="pointer-events-none absolute -bottom-[40px] sm:-bottom-[60px] md:-bottom-[80px] -right-[40px] sm:right-0 md:right-0 z-30 w-[260px] sm:w-[330px] md:w-[380px] lg:w-[482px]"
				aria-hidden="true"
			>
				<img
			...
			{/* Logo Marquee */}
			<div
				className="absolute bottom-12 left-1/2 -translate-x-1/2 w-full max-w-3xl xl:max-w-5xl 2xl:max-w-7xl overflow-hidden z-20"
				style={{
					maskImage:
